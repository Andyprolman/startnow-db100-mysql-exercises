...
SELECT DISTINCT amount, payment_id, payment_date
...
FROM payment WHERE DATE(payment_date) = DATE('2005-05-27');
...
SELECT customer.first_name as customer_last_name,
